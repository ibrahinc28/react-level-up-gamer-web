...
describe('BlogPage Component', () => {
  ...
  test('debe renderizar la página del blog correctamente', () => {
  ...
  test('debe renderizar artículos de cada categoría', () => {
    renderWithRouter(<BlogPage />);
  ...
  test('debe renderizar todos los botones "Leer más"', async () => {
    renderWithRouter(<BlogPage />);
